...
0.1	Установочный файл можно скачать приведенным ниже адресам:
...
0.2.1	Рекомендуемое программное обеспечение для сборки из исходных файлов:
	...
	2) GIT. Для получения сиходных файлов в виде git-репозитория. 
...
0.2.3	Сборка установщика
	1) Перейдите каталог, содержащий файл mnas_acad_utils.nsi.
