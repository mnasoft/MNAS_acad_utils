...
1.1.1	Предполагаается, что в процессе работы с комплексом программ
	пользователь будет подгружать частичное меню и возможно,
	захочет что-то поправить в исходном коде программ.
	Для обеспечения вышеуказанных возможностей разрешите
	изменение содержимого каталога с комплексом программ
	для пользователей, которые будут с ним работать.
