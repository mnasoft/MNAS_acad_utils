...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Óòèëèòû äëÿ ğàáîòû ñ AutoCAD© (2007-2011)"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "${VERSION}"

VIAddVersionKey /LANG=${LANG_RUSSIAN} "ProductName" "Mnas_acad_utils"
VIAddVersionKey /LANG=${LANG_RUSSIAN} "Comments" "Óòèëèòû äëÿ ğàáîòû ñ AutoCAD© (2007-2011)"
...
VIAddVersionKey /LANG=${LANG_RUSSIAN} "LegalCopyright" "Ğàñïğîñòğàíÿåòñÿ ïî ëèöåíçèè GNU GPL v3.0"
VIAddVersionKey /LANG=${LANG_RUSSIAN} "FileDescription" "Óòèëèòû äëÿ ğàáîòû ñ AutoCAD© (2007-2011)"
