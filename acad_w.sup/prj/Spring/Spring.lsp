(setq
  spring_1
	   '(
	     ("d_provoloka" 2.5)	; Диаметр проволоки пружины, мм.
  ...
  spring_2
	   '(
	     ("d_provoloka" 4.5)	; Диаметр проволоки пружины, мм.
  ...
  spring_3i5
	   '(
	     ("d_provoloka" 3.5)	; Диаметр проволоки пружины, мм.
	     ("D_sredn" 40.0)		; Средний диаметр пружины, мм.
  ...
  spring_05
	   '(
	     ("d_provoloka" 1.0)	; Диаметр проволоки пружины, мм.
