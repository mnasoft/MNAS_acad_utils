...
(defun c:ins_lit
  ...
  (setq
    v-nm-val (m_ch_var v-nm-val) ; установка значений системных переменных
...
(defun c:draw_font
  ...
  (setq
    v-nm-val (m_ch_var v-nm-val)
  )  ; восстанавливает значений системных переменных
  (princ)
)
