...
(defun ax:init	(n)
  (if (null gr)
    (setq gr (list (list (cons 1 "Безымянный")
			 (cons 10 '(1 1))
			 ...
			 (cons "Параметры точек"
			       (list (cons 70 2)
				     (list "Блок"
					   ...
					   (cons 8 "0")
					   (cons 62 256))
				     (list "Линия" (cons 40 1.0) (cons 6 "ПОСЛОЮ") (cons 8 "0") (cons 62 256))))))))
		    ;if
  (if (null scal)
    (setq scal (list (list "Шкала X"
			   (list '(0 . "LINE")
				 ...
				 '(11 150 0 0)
				 (list -3
				       (list "SHCKALA"		  '(1002 . "{")	       '(1040 . 0.0)
					     '(1040 . 100.0)	  '(1070 . 0)	       '(1000 . "X-шкала")
					     '(1002 . "}")))))
		     (list "Шкала Y"
			   (list '(0 . "LINE")
				 '(10 0 0 0)
				 ...
				 (list -3
				       (list "SHCKALA"		  '(1002 . "{")	       '(1040 . 0.0)
					     '(1040 . 100.0)	  '(1070 . 0)	       '(1000 . "Y-шкала")
					     '(1002 . "}")))))))
    (princ scal))
  (setq	l-gr	(nth n gr)
