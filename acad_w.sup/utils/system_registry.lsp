...
;;;      rgb_registry '((code_val (("eb_1_2" . "0") ("eb_1_3" . "1")))
;;;		     (code_val_1 (("1_2" . "0") ("1_3" . "1"))))
;;;)
;;;(reg_read_default_lst reg_root rgb_registry)
;;;(reg_write_default_lst reg_root rgb_registry)
(defun reg_read_default_lst  (root lst)
  (mapcar (function (lambda (el) (reg_read_default root (car el) (cadr el)))) lst))
...
(defun reg_write_lst  (root lst) ; По просьбе Давлеткужина
  (mapcar (function (lambda (el) (reg_write root (car el) (cadr el)))) lst))
...
(defun reg_write_default_lst  (root lst)
  (mapcar (function (lambda (el) (reg_write_default root (car el) (cadr el)))) lst))
