...
(defun setup_l_3_1  ()
  ...
  (mapcar (function
	    (lambda (e)
	      (add_list (apply 'strcat (mapcar (function (lambda (e1) (strcat (cdr e1) "\t"))) e)))))
	  sp_poz)
  (end_list))
...
(defun ac_b_3_4	 ()
  ...
  (mapcar (function (lambda (e)
		      (setq dlg_1_kv (subst (cons (cdr e) (cdr (assoc (car e) sp_curr)))
...
(defun setup_f3_dialog	(/ temp)
  (setq temp 0)
  (setq	sp_curr
	 (mapcar (function (lambda (e) (cons (car e) (cdr (assoc (cdr e) dlg_1_kv))))) d1_sp_curr))
