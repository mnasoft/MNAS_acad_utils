...
(defun ac_1_info  ()
  (alert "Ðàçðàáîòàë Ìàòâååâ Í.À.\nÓêðàèíà\nòåëåôîíû:\näîì. (0512)228873\nðàá. (0512)297411"))

(defun ac_1_help  ()
  (help (strcat (acad_sup) "/spec/Specification.ahp" "ñïåöèôèêàöèÿ_ïðîñòàíîâêà_ïîçèöèé")))
...
(defun ac_b_1_5	 (/ bl_name tb a_st_pol a_napr a_delta poz_scale nm_lst pos_lst val_lst sc_lst atr_lst)
  (setq	val_lst	(mapcar
	...
	nm_lst	(list "ÒÅÊÑÒ"	       "ÑÏÅÖÈÔÈÊÀÖÈß"	"ÂÀÐÈÀÍÒ"	 "ÔÎÐÌÀÒ"
		      "ÇÎÍÀ"	       "ÏÎÇÈÖÈß"	"ÎÁÎÇÍÀ×ÅÍÈÅ"	 "ÍÀÈÌÅÍÎÂÀÍÈÅ"
  ...
  (mapcar (function
	  ...
	  sc_lst
	  atr_lst)
  (entmake (list (cons 0 "SEQEND"))) ; Êîíåö ïîñëåäîâàòåëüíîñòè àòðèáóòîâ
