(defun update_ver_rou (stp_lst / bak0 cur)
;;; Обновить версию для шероховатости.
  (setq	bak0 (mapcar (function car) setup_lst_bak0)
  ...
  (cond
	...
	(list
	  ...
	  (list "eb_1_min_val" "5")
	  (list "pl_1_min_val" "4" (list "80" "40" "20" "10" "5" "2,5" "1,25" "0,63" "0,32" "0,16" "0,08"))
	  ...
	  (list	"pl_1_masht"
		"11"
		(list "100:1" "50:1" "40:1" "25:1" "20:1" "15:1" "10:1"	"5:1" "4:1" "2.5:1" "2:1" "1:1"	"1:2" "1:2.5" "1:4" "1:5" "1:10" "1:15"	"1:20"
		      "1:25" "1:40" "1:50" "1:100")
	  )
