(setq rou_1-rou_lists
       '(("Ra "
	  ("0"
	   ("Ra 50"	 "Ra 25"      "Ra 12,5"	   "Ra 6,3"	"Ra 3,2"     "Ra 1,6"	  "Ra 0,8"
	    "Ra 0,4"	 "Ra 0,2"     "Ra 0,1"	   "Ra 0,05"	"Ra 0,025"   "Ra 0,012"	  "Ra 0,006"))
	  ("1"
	   ("Ra 80"	 "Ra 40"      "Ra 20"	   "Ra 10"	"Ra 5"	     "Ra 2,5"	  "Ra 1,25"
	    "Ra 0,63"	 "Ra 0,32"    "Ra 0,16"	   "Ra 0,08"	"Ra 0,04"    "Ra 0,02"	  "Ra 0,01"))
	  ("2"
	   ("Ra 63"	 "Ra 32"      "Ra 16"	   "Ra 8"	"Ra 4"	     "Ra 2"	  "Ra 1"
	    "Ra 0,5"	 "Ra 0,25"    "Ra 0,125"   "Ra 0,063"	"Ra 0,032"   "Ra 0,016"	  "Ra 0,008"))
	  ("3"
	   ("Ra 40"	 "Ra 20"      "Ra 10"	   "Ra 5"	"Ra 2,5"     "Ra 1,25"	  "Ra 0,63"
	    "Ra 0,32"	 "Ra 0,16"    "Ra 0,08"	   "Ra 0,04"	"Ra 0,02"    "Ra 0,01"	  "Ra 0,005")))
	 ("Rz "
	  ("0"
	 ...
	 '((rou_1-dia_sher_pos (-1 -1))
	   (setup_lst
	    (("rb_1_Ra" "1") ;
	     ...
	     ("pl_1_spos_pol"
	      "0"
	      ("Шабрить" "Развертывать"	"Протягивать" "Шлифовать" "Притереть" "Полировать" "Хонинговать"
	       "Накатать")) ;pl_1_2 ; Способ получения шероховатости; "Притереть" "Полировать"
	     ...
	     ("pl_1_napr_miko_ner"
	      "0"
	      ("Параллельное" "Перпендикулярное" "Скрещенное" "Кольчужное" "Концентричное" "Радиальное"
	       "Точечное")) ;ppl_1_1
