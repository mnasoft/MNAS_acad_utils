...
(setq
  rou_lists
   '(
     ("Ra "
      ("0"
       ("Ra 50" "Ra  25" "Ra  12,5" "Ra  6,3" "Ra  3,2" "Ra  1,6" "Ra  0,80" "Ra  0,40" "Ra  0,20" "Ra 0,10" "Ra 0,05" "Ra 0,025" "Ra 0,012" "Ra 0,006")
      )
      ("1"
       ("Ra 80" "Ra 40" "Ra 20" "Ra 10" "Ra 5" "Ra 2,5" "Ra 1,25" "Ra 0,63" "Ra 0,32" "Ra 0,16" "Ra 0,08" "Ra 0,040" "Ra 0,02" "Ra 0,01")
      )
      ("2"
       ("Ra 63" "Ra 32" "Ra 16" "Ra 8" "Ra 4" "Ra 2" "Ra 1" "Ra 0,5" "Ra 0,25" "Ra 0,125" "Ra 0,063" "Ra 0,032" "Ra 0,016" "Ra 0,008")
      )
      ("3"
       ("Ra 40" "Ra 20" "Ra 10" "Ra 5" "Ra 2,5" "Ra 1,25" "Ra 0,63" "Ra 0,32" "Ra 0,16" "Ra 0,080" "Ra 0,040" "Ra 0,020" "Ra 0,010" "Ra 0,005")
      )
     )
     ("Rz "
      ("0"
       ("Rz 320" "Rz 160" "Rz 80" "Rz 40" "Rz 20" "Rz 10" "Rz 6,3" "Rz 3,2" "Rz 1,6" "Rz 0,80" "Rz 0,40" "Rz 0,20" "Rz 0,1" "Rz 0,05")
      )
      ("1"
       ("Rz 250" "Rz 125" "Rz 63" "Rz 32" "Rz 16" "Rz 8" "Rz 5" "Rz 2,5" "Rz 1,25" "Rz 0,63" "Rz 0,32" "Rz 0,16" "Rz 0,08" "Rz 0,04")
      )
      ("2"
       ("Rz 200" "Rz 100" "Rz 50" "Rz 25" "Rz 12,5" "Rz 6,3" "Rz 4,0" "Rz 2,0" "Rz 1,00" "Rz 0,50" "Rz 0,25" "Rz 0,125" "Rz 0,063" "Rz 0,032")
      )
      ("3"
       ("Rz 160" "Rz 80" "Rz 40" "Rz 20" "Rz 10" "Rz 5" "Rz 3,2" "Rz 1,60" "Rz 0,80" "Rz 0,40" "Rz 0,20" "Rz 0,100" "Rz 0,050" "Rz 0,025")
      )
     )
    )
)
...
(setq
  setup_lst_bak0
   '(
     ...
     ("pl_1_2" "0" ("Притереть" "Полировать"))
     ;Способ получения шероховатости
     ("error" "") ; Поток ошибок
    )
)
...
(defun c:rou (/ dcl_id do_dialog p1 p2 fl fl_nm old_err kw str_kw osm reg_root rou_registry)
	 ...
	 '((dia_sher_pos (-1 -1))
	   (setup_lst
	    (
	     ...
	     ("pl_1_spos_pol"
	      "0"
	      ("Шабрить"	 "Развертывать"	   "Протягивать"     "Шлифовать"
	       "Притереть"	 "Полировать"	   "Хонинговать"     "Накатать"
	      )
	     ...
	     ("pl_1_napr_miko_ner"
	      "0"
	      ("Параллельное"	    "Перпендикулярное"	 "Скрещенное"
	       "Кольчужное"	    "Концентричное"	 "Радиальное"
	       "Точечное"
	      )
	     ) ;ppl_1_1
	     ...
	     ("pl_1_masht"
	      "11"
	      ("100:1"	 "50:1"	   "40:1"    "25:1"    "20:1"	 "15:1"	   "10:1"
	       "5:1"	 "4:1"	   "2.5:1"   "2:1"     "1:1"	 "1:2"	   "1:2.5"
  ...
  (setq
    setup_lst
     (subst (list "eb_1_masht" (rtos (getvar "DIMSCALE") 2 4))
  ...
  (while do_dialog
    ...
    (cond
	 ...
	 (setq
	   setup_lst
	    (subst
	      (cons "error" "Необходимо вводить две точки !")
	      (assoc "error" setup_lst)
	      setup_lst
	    )
	 )
	 ...
	 (progn
	   ...
	   (if (and ob vl-data)
		 ...
		 p2	   (vlax-safearray->list
			     (vlax-variant-value
			       (vlax-get-property ob 'InsertionPoint)
			     )
			   )
		 dp	   (mapcar (function -)
	 ...
	 (setq setup_lst (subst	(list "error" "Ничего не выбрано")
				(assoc "error" setup_lst)
				setup_lst
			 )
	 )
...
(defun ac_1 (/ temp)
  ...
  (setq	setup_lst
	 (subst	(list "eb_1_masht" (rtos temp 2 4))
		(assoc "eb_1_masht" setup_lst)
		setup_lst
	 )
  )
...
(90 2 15 2 nil "end of" 60 9 0 0 0 T T nil T)
