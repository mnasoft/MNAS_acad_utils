(defun dim-restore () (command "-dimstyle" "_Restore" (getvar "dimstyle")))

(defun toh-0 () (dim-restore) (command "DIMTOH" 0) (command "_dim1" "_update" ss ""))

(defun toh-1 () (dim-restore) (command "DIMTOH" 1) (command "_dim1" "_update" ss ""))
