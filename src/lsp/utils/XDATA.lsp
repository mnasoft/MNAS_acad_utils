...
;;_$ (_xd_applength (axis:sel "sss") (axis:app-name))
;;4

;; _xd_xdapp (da app)
;;	Функция добавления ИСкО к РДП-ССП без ИСкО
;;_$ (_xd_xdapp '((1040 . 0.0) (1040 . 100.0) (1070 . 0) (1000 . "Самаякая Y")) (axis:app-name))
...
;;_$ (xdapplength (axis:sel "укажите шкалу"))
;;1

;;xdxdapp(xdata app)
;;	Функция извлечения из РДП РДП-ССП
;;_$ (xdxdapp (assoc -3 (axis:sel "укажите шкалу")) (axis:app-name))
;;("SHCKALA" (1002 . "{") (1040 . 0.0) (1040 . 100.0) (1070 . 0) (1000 . "Некая шкала x") (1002 . "}"))
