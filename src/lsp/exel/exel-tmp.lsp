...
(setq rng(vlax-get-property (exel-open "C:\\Develop\\MNAS_acad_utils\\src/lsp\\exel\\Book.xlsx" "Лист1") "UsedRange"))
;;;(exel-open "C:\\Develop\\MNAS_acad_utils\\src/lsp\\exel\\Book.xlsx" "Лист1")
