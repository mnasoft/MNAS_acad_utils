...
(defun line-concat-dlg  (/ dcl_id       ; id диалога
        ...
        line-concat-dlg_pos
         '(-1 -1)
        do_dialog t)
  (setq dcl_id (load_dialog "./src/lsp/lines/line_concat.dcl"))
  (while do_dialog
...
(defun lines-j_lns-info () (alert (strcat "Объединение наложенных друг на друга отрезков " (about-gpl-string))))
